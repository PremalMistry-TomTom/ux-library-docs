...
const MOSAIC_CARDS = [
  ...
  { id: 'm-ev-route',        Illo: makeThumb(IlloEVRouting,            L_EVRouting,            IcoEVRouting),            cats: ['navigation','mobility'],  solutions: ['ev-charging','routing'],             emoji: '⚡', title: 'Plan long-distance EV trips',                  problem: 'Route an EV across hundreds of kilometres with optimised charging stops based on battery SOC and speed.',                                                                              product: 'Long Distance EV Routing API',     docsId: 'ldevr-calculate-route', productId: 'ldevr' },
  { id: 'm-ldevr-batch',     Illo: makeThumb(IlloBatchRouting,         L_BatchRouting,         IcoBatchRouting),         cats: ['navigation','mobility'],  solutions: ['ev-charging','routing','fleet-mobility'], emoji: '📦', title: 'Batch-plan multiple EV routes',                problem: 'Submit dozens of EV origin-destination pairs in a single request and receive optimised charging-stop plans back in parallel.',                                                          product: 'Long Distance EV Routing API',     docsId: 'ldevr-batch',          productId: 'ldevr' },
  { id: 'm-ldevr-weather',   Illo: makeThumb(IlloRoutingWeather,       L_RoutingWeather,       IcoRoutingWeather),       cats: ['navigation','mobility'],  solutions: ['ev-charging','routing'],             emoji: '🌧️', title: 'Factor weather into EV range',                problem: 'Adjust charging-stop selection and range estimates based on real-time weather — cold, rain, and headwinds all reduce battery capacity.',                                                 product: 'Long Distance EV Routing API v2',  docsId: 'ldevr-weather',        productId: 'ldevr' },
  { id: 'm-ldevr-brand',     Illo: makeThumb(IlloEVBattery,            L_EV,                   IcoEVBattery),            cats: ['automotive','mobility'],  solutions: ['ev-charging'],                       emoji: '🚗', title: 'Look up a vehicle brand battery model',        problem: 'Retrieve pre-loaded consumption and battery profiles for a specific EV make and model without supplying raw vehicle parameters.',                                                        product: 'Long Distance EV Routing API v2',  docsId: 'ldevr-vehicle-brand',  productId: 'ldevr' },
  { id: 'm-ldevr-toll',      Illo: makeThumb(IlloCalculateRoute,       L_CalculateRoute,       IcoCalculateRoute),       cats: ['navigation','mobility'],  solutions: ['ev-charging','routing'],             emoji: '💶', title: 'Include toll costs in EV trip plans',          problem: 'Get itemised toll charges for every road segment on a long-distance EV route alongside energy costs in a single response.',                                                             product: 'Long Distance EV Routing API v2',  docsId: 'ldevr-compute-toll',   productId: 'ldevr' },
  { id: 'm-ldevr-parks',     Illo: makeThumb(IlloEVChargingAvailability,L_EVChargingAvailability,IcoEVChargingAvailability),cats: ['mobility'],             solutions: ['ev-charging'],                       emoji: '🕐', title: 'Check charging park opening hours',            problem: 'Validate that planned charging stops will be open when the vehicle is predicted to arrive — avoiding closed stations on night drives or public holidays.',                               product: 'Long Distance EV Routing API v2',  docsId: 'ldevr-charging-parks', productId: 'ldevr' },
  { id: 'm-ldevr-emsp',      Illo: makeThumb(IlloEVSearchNearby,       L_EVSearchNearby,       IcoEVSearchNearby),       cats: ['automotive','mobility'],  solutions: ['ev-charging'],                       emoji: '🔑', title: "Route to the driver's eMSP-preferred chargers", problem: 'Prioritise charging stops at networks where the driver has an active subscription or tariff, and surface SEV entitlement keys for seamless session start.',                              product: 'Long Distance EV Routing API v2',  docsId: 'ldevr-oem-emsp',      productId: 'ldevr' },
  { id: 'm-ldevr-freshness', Illo: makeThumb(IlloTrafficModelID,       L_TrafficModelID,       IcoTrafficModelID),       cats: ['mobility'],              solutions: ['ev-charging'],                       emoji: '🔄', title: 'Query live EV data freshness',                 problem: 'Check when charging-station availability and pricing data was last refreshed so you can decide whether to fetch a live update or show a staleness indicator.',                          product: 'Long Distance EV Routing API v2',  docsId: 'ldevr-data-freshness', productId: 'ldevr' },
...
const DISC_TABS = [
  { id: 'all',               label: 'All' },
  { id: 'in-vehicle',        label: 'In-Vehicle UX' },
  { id: 'routing',           label: 'Routing' },
  { id: 'ev-charging',       label: 'EV & Charging' },
  { id: 'maps-gis',          label: 'Maps & GIS' },
