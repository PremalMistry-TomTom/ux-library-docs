...
/* ─── V3 Orbis Maps — EV Search Nearby ──────────────────────────────────────
...
const PARAMS = [
  ...
  { name: 'connector', type: 'string', desc: 'Comma-separated connector type IDs. Example: IEC62196Type2Outlet,IEC62196Type2CCS,Chademo,IEC62196Type2CableAttached.' },
...
const CODE = `# EV Search Nearby (v3 Orbis) — available CCS chargers ≥50 kW within 2 km of Amsterdam Centraal
...
export function EVSearchNearbyV3Content({ onNavigate }) {
  return (
    <>
      <PrivatePreviewBanner api="EV & Charging API v3 (Orbis Maps)" />
      <ApiRefTwoCol
        description="Discover EV charging stations within a circular area or bounding box using the Orbis Maps EV endpoint. Same rich filter set as v1 plus JMESPath response filtering. Requires the TomTom-Api-Version: 1 header on every request."
        sections={[
          {
            id: 'request',
            heading: 'Request',
