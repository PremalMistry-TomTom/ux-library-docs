export const TRAFFIC_API_NAV = [
  ...
  { id: 'traffic-flow-segment',     label: 'Traffic Flow',      type: 'top', ref: true },
  { id: 'traffic-incident-details', label: 'Traffic Incidents', type: 'top', ref: true },
  { id: 'traffic-flow-tiles',       label: 'Flow Tiles',        type: 'top', ref: true },
  { id: 'traffic-model-id',         label: 'Traffic Model ID',  type: 'top', ref: true },
];
