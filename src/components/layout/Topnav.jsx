...
function TomTomLogo() {
  return (
    <svg width="100" height="19" viewBox="0 0 125 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="TomTom">
        ...
        {ctx.type !== 'top' && (
          <>
            ...
            {ctx.type === 'page' && ctx.landingId ? (
              ...
              <span className="topnav-crumb-page">{domainLabel}</span>
            )}
          </>
        )}
